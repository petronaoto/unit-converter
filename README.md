# O&G Engineering Converter — v3.2
...
| Document | Contents |
|---|---|
| [docs/DEVELOPMENT_PLAN.md](docs/DEVELOPMENT_PLAN.md) | Vision, personas, architecture principles, full version history, the i18n program milestones, and the v3.2 outcome with the v3.3 candidates |
