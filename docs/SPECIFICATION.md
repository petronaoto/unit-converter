...
- `i18n/ja.json`, `zh.json`, `ko.json`, `th.json`, `id.json`, `ru.json`, `es.json`, `fr.json`, `de.json` — each carries the full 368-key working-tool set **plus** the 139 `docs.*` documentation keys (125 shipped in v2.7; the remaining 14 v2.8 blocks translated in v2.8.1).
