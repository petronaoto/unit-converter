...
**Inclination gate (Day 9, verified 2026-08-21; gate CHANGED in v3.7.1 — see below).**
...
> ⚠️ **The gate became DIRECTIONAL in v3.7.1, after Day 9 was written and scheduled.**
...
> written and published on Mon 24 Aug and is the pre-v3.7.1 behaviour. Maintainer's decision
...
> ✅ **RESOLVED — the maintainer chose to refine the gate (2026-08-21), shipped as v3.7.1.**
...
- **"I published a post about this gate on Monday. By Wednesday I had changed it."** — the
  ...
  exactly what stratifies. v3.7.1 made the gate directional. Ready to write — the numbers are in
