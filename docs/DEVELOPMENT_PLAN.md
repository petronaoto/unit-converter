...
**Document version:** 2.0 (accompanies app v3.6)
...
- **Advanced:** Compositional GHV & Flow (JIS K 2301, 14 components, HHV/LHV/SG/WI/MCP/MW, ISO 6578 LNG density, mass↔vol↔mol flow, **LNG reference-composition presets with live published-value cross-check — v3.3**), **LNG Cargo Estimator (v3.5: 36-vessel sourced catalogue, loaded/delivered t · kNm³ · TBtu)**, Pipe ΔP (Darcy-Weisbach + Colebrook-White + HEM two-phase + RP 14E erosion check + **v2.8 Crane TP-410 fittings and NORSOK P-001 line-sizing screen**), Flow Regime (Hewitt & Roberts / Baker maps + 3D animation).
