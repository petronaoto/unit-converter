...
**Document version:** 2.2 (accompanies app v3.8)
...
- **Safety:** API 520 Part I PRV sizing, five modes, API 526 orifice letters; **v3.8:** per-field pressure unit selects with Abs/Gauge basis, ⇩ import from the General tab Pressure card, one-click defaults (gas → orifice H).
...
| One-click defaults (gas → orifice H; other modes on Vector 4) | High | S | **Shipped v3.8** — new Vector 15, `tests/test_psv_pressure_inputs.py` |
