...
- **App**: O&G Engineering Converter v2.8.1 — a control-room-ready unit conversion and engineering calculation suite for the Oil & Gas / LNG sector.
...
- **Architecture**: Hybrid Edge-Server
  ...
  - `docs/` (v2.8.1) — `DEVELOPMENT_PLAN.md` (history + roadmap, incl. the i18n program milestones), `SPECIFICATION.md` (full feature & API spec, known-issues register, §12 i18n architecture), `MARKETING.md` (promotion strategy).
