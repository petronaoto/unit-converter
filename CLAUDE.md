...
- **App**: O&G Engineering Converter v3.2 — a control-room-ready unit conversion and engineering calculation suite for the Oil & Gas / LNG sector.
...
- **Architecture**: Hybrid Edge-Server
  ...
  - `docs/` (v3.2) — `DEVELOPMENT_PLAN.md` (history + roadmap, incl. the i18n program milestones), `SPECIFICATION.md` (full feature & API spec, known-issues register, §12 i18n architecture), `MARKETING.md` (promotion strategy), `POST.md` (the live LinkedIn campaign log — see below).
